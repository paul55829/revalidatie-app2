...
public class ExerciseFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pdfView = (PDFView) root.findViewById(R.id.exercise);

        //gets the name and url of the file that has to be showed
        Bundle bundle = getArguments();
        String[] info = bundle.getStringArray("com.example.revalidatieapp.INFO_EXERCISE");
    ...
    private void startDownloading(){
        ...
        request.setDescription("Downloading the exercise....");
        ...
        switch (requestCode) {
            case PERMISSION_STORAGE_CODE:{
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(getContext(), "cannot load exercise", Toast.LENGTH_SHORT);
                }
            }
        }
    }
